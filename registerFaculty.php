<?php 
$id = date("Y") . "-". "02" . substr(hexdec(uniqid()), 12) . date("s");
?>
            ...
            <div class="container mt-5">
                <form name="officials" method="POST" action="./database/insertDB.php" enctype="multipart/form-data">
                    ...
                    <center>
                        <div class="row mb-5">
                            <div class="col-md-12">
                                <button type="submit" name="btnRegisterFaculty" onClick="checkValidation()" class="btn btn-primary btn-block btn-large">Register</button>
                            </div>
                        </div>
                    </center>
                </form>
